            ...
            <div id="carouselExampleIndicators" className="carousel slide">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  ...
                  >
                    This project was inspired by a common frustration from my
                    time in retail: whenever our point-of-sale system
                    (frequently) crashed, we were reduced to using a cumbersome
                    combination of calculators and Excel spreadsheets to take
                    cash from customers. Backup Cash Register is intended as a
                    sleek, user-friendly plan B, calculating discount, tax and
                    change so that harried retail workers don't have to. Users
                    can also save their transactions to their account, for later
                    reference.
                  </div>
                  <br />
                </div>
                <div className="carousel-item">
                  ...
                  >
                    ...
                    Vonnegut's Sirens of Titan. In Sirens, the caves of Mercury
                    are inhabited by a primitive species called Harmoniums who
                    can only communicate two thoughts: "I am here" and "So glad
                    you are". And isn't this all actually want from social
                    media: to announce our presence, and to be acknowledged?
                    Caves of Mercury uses this contraint to offer users a zen
                    experience of pure, uncomplicated connection.{" "}
                  </div>
                  <br />
                </div>
                <div className="carousel-item">
                  ...
                  >
                    ...
                    accept and reject friend requests, join groups, and chat
